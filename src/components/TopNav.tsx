        ...
        <div className="bg-gray-800 border-b border-gray-700 px-3 sm:px-4 py-3">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
            ...
            <div className="text-lg font-mono tabular-nums min-w-[4ch] text-center text-white">
              {recorder.status === 'recording' ? formatRecorderTime(recorder.durationMs) : '0:00'}
            </div>

            {/* Level meter */}
            <div className="w-24 sm:w-32 h-2 bg-gray-700 rounded overflow-hidden">
              <div
                className={`h-full transition-[width] duration-75 ${
                  recorder.level > 0.85 ? 'bg-red-500' : recorder.level > 0.6 ? 'bg-yellow-500' : 'bg-green-500'
                }`}
            ...
            >
              {recorder.status === 'recording' ? (
                ...
                <>
                  ...
                  {recorderUploading ? 'Saving…' : 'Record'}
                </>
              )}
            </button>
            ...
            <Link
              ...
              className="px-3 py-2 rounded-md text-sm bg-gray-700 hover:bg-gray-600 text-gray-200 text-center"
            >
              View all →
            </Link>
          </div>
